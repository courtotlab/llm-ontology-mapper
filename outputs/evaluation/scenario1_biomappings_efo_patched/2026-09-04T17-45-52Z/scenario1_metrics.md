...
| --- | --- | --- | --- | --- |
| Top-1 | 0.9610 | 795 | unique_query | OK |
| Top-3 | 0.9786 | 795 | unique_query | OK |
| Top-5 | 0.9786 | 795 | unique_query | OK |
| MRR | 0.9696 | 795 | unique_query | OK |
| Recall@GT | 0.9610 | 795 | unique_query | OK |
| % Same | 0.9610 | 795 | unique_query | OK |
...
| Precision | 0.9771 | 795 | unique_query | OK |
| Recall | 0.9897 | 795 | unique_query | OK |
| F1 | 0.9834 | 795 | unique_query | OK |
...
- Exact-only diagnostic (NEVER the official TP-taxonomy result): treats every TP-Related row as FP-Error instead -- precision=0.9708, recall=0.9896, f1=0.9801
