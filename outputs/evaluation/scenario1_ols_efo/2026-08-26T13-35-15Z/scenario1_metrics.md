...
| --- | --- | --- | --- | --- |
| Top-1 | 0.5500 | 20 | unique_query | OK |
| Top-3 | 0.6000 | 20 | unique_query | OK |
| Top-5 | 0.6000 | 20 | unique_query | OK |
| MRR | 0.5750 | 20 | unique_query | OK |
| Recall@GT | 0.5000 | 20 | unique_query | OK |
| % Same | 0.5500 | 20 | unique_query | OK |
| % More Specific | None | 20 | unique_query | OK |
| % More General | 0.0500 | 20 | unique_query | OK |
| % Sibling | None | 20 | unique_query | OK |
| % Unrelated | 0.4000 | 20 | unique_query | OK |
| Precision | 0.6000 | 20 | unique_query | OK |
| Recall | 1.0000 | 20 | unique_query | OK |
| F1 | 0.7500 | 20 | unique_query | OK |

- Denominator: 20 unique queries (see Part 4/21 -- unique-query is the PRIMARY denominator).
- Recall@GT computed over 20/20 rows with a defined gold set.
...
- Exact-only diagnostic (NEVER the official TP-taxonomy result): treats every TP-Related row as FP-Error instead -- precision=0.5500, recall=1.0000, f1=0.7097
