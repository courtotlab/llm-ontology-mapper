...
| --- | --- | --- | --- | --- |
| Top-1 | 0.8348 | 7377 | unique_query | OK |
| Top-3 | 0.8600 | 7377 | unique_query | OK |
| Top-5 | 0.8620 | 7377 | unique_query | OK |
| MRR | 0.8470 | 7377 | unique_query | OK |
| Recall@GT | 0.8315 | 7377 | unique_query | OK |
| % Same | 0.8348 | 7377 | unique_query | OK |
| % More Specific | 0.0072 | 7377 | unique_query | OK |
| % More General | 0.0094 | 7377 | unique_query | OK |
| % Sibling | 0.0060 | 7377 | unique_query | OK |
| % Unrelated | 0.1292 | 7377 | unique_query | OK |
| Precision | 0.8690 | 7377 | unique_query | OK |
| Recall | 0.9844 | 7377 | unique_query | OK |
| F1 | 0.9231 | 7377 | unique_query | OK |

- Denominator: 7377 unique queries (see Part 4/21 -- unique-query is the PRIMARY denominator).
- Recall@GT computed over 7377/7377 rows with a defined gold set.
...
- Exact-only diagnostic (NEVER the official TP-taxonomy result): treats every TP-Related row as FP-Error instead -- precision=0.8462, recall=0.9840, f1=0.9099
