...
| --- | --- | --- | --- | --- |
| Top-1 | 0.7905 | 888 | unique_query | OK |
| Top-3 | 0.8874 | 888 | unique_query | OK |
| Top-5 | 0.8975 | 888 | unique_query | OK |
| MRR | 0.8396 | 888 | unique_query | OK |
| Recall@GT | 0.7905 | 888 | unique_query | OK |
| % Same | 0.7905 | 888 | unique_query | OK |
| % More Specific | 0.0169 | 888 | unique_query | OK |
| % More General | 0.0270 | 888 | unique_query | OK |
| % Sibling | 0.0135 | 888 | unique_query | OK |
| % Unrelated | 0.1475 | 888 | unique_query | OK |
| Precision | 0.8518 | 888 | unique_query | OK |
| Recall | 0.9947 | 888 | unique_query | OK |
| F1 | 0.9177 | 888 | unique_query | OK |
...
- Exact-only diagnostic (NEVER the official TP-taxonomy result): treats every TP-Related row as FP-Error instead -- precision=0.7941, recall=0.9943, f1=0.8830
